...
def run(app_config, options):
    ...
    def create_sound_clip_task(app, sound_clip,  priority=0):
        # Data for the tasks
        task_info = sound_clip
        try:
